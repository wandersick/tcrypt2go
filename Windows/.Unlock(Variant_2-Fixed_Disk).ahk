...
File_Description=Open Protected Drive (TrueCrypt Partition)
...
; Description: Run to unlock drive on Windows for TrueCrypt partitions (primarily used on external media of a 'fixed disk' type such as USB hard disks)
; Version: 2.0
; Date: 17-Feb-2018
; Language: AutoHotkey
...
If A_IsAdmin
{
	Run, "%A_ScriptDir%\.DO_NOT_DELETE\tc.exe" /w /c n /a devices /q /e, %A_ScriptDir%, min
	ExitApp
}
